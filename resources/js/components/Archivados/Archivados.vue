		...
		<div class="card" >
			<div class="card-header  p-3">
				<h4 class="user-select-none m-0 p-0">
					<i class="fas fa-inbox-in fa-lg mr-2"></i>
					Documentos en Archivados
				</h4>
			</div>
			<div class="card-body">
					...
					<table class="table table-hover table-xs table-personal">
						<thead>
							<tr class="text-center">
								...
								<th class="text-left" >Proveido</th>
							</tr>
						</thead>
						<tbody>
							...
							<template v-else>
								<tr v-for="(documento,index) in listDocumetos.data" :key="index" class="text-uppercase text-center">
									<td >
										<button class="btn btn-mini btn-success" @click="antesDesarchivar(documento)">
									...
									<td class="text-left">{{ documento.proveido }} - <strong>ARCHIVADO EN {{ documento.archivador.nombre }} {{ documento.archivador.periodo }}</strong></td>
								</tr>
							</template>
						</tbody>
						<tfoot>
...
<script src="@/components/Archivados/Archivados.js"></script>
<style scoped>
	.vue-html2pdf{
