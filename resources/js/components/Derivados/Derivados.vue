					...
					<table class="table table-hover table-xs table-personal">
						<thead>
							<tr class="text-center">
								...
								<th width="100px">Fecha Derivación</th>
						...
						<tbody>
							...
							<template v-else>
								<tr v-for="(documento,index) in listDocumetos.data" :key="index" class="text-uppercase text-center">
										...
										<div class="btn-group">
		                                    ...
		                                    <div class="dropdown-menu dropdown-menu-right dropdown-personal text-capitalize py-2">
		                                        <a href="#" @click="accionDerivar(documento)" class="dropdown-item  px-2 m-0" >
		                                        	...
		                                        	<span>Derivar más</span>
		                                        </a>

		                                        <a href="#" class="dropdown-item  px-2 m-0" @click="antesEliminarDerivacion(documento)" >
		                                            <i class="fas fa-trash-undo-alt mr-1 text-danger"></i>
		                                            <span>Eliminar Derivación</span>
		                                        </a>
	                                        </div>
		                                </div>
									...
									<td class="text-left">
										<template v-if="documento.derivado_oficina">
											<strong>{{ documento.derivado_oficina.nombre }}</strong>
										</template>
										<template v-if="documento.derivado_usuario">
											<br>
											<label class="label  label-info">USUARIO</label> {{ documento.derivado_usuario.full_name }}
										</template>
									</td>
								</tr>
							</template>
...
<script src="@/components/Derivados/Derivados.js"></script>
<style scoped>
	.vue-html2pdf{
