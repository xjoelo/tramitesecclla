<template>
    <div>
        <div class="card">
            ...
            <form action="/reporte/generados" method="POST" autocomplete="off">
                ...
                <div class="card-block">
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-12">
                            <label for="nroDocumentoTipo" class="text-uppercase">Mostrar solo documentos generados por el usuario:</label>
