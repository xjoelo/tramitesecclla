                                ...
                                @foreach ($documentos as $documento)
                                    <tr>
                                        <td class="format-numero" style="font-size: 15px !important">
                                            <a href="/seguimiento-externo/{{ $documento->id }}/{{ $documento->nroDocumentoPersona }}">{{ $documento->origenDocumento == 0 ?"I":"E" }}{{ str_pad($documento->nroDocumento, 8, "0", STR_PAD_LEFT) }}</a>
                                        </td>
                ...
                @else
                    <div class="row">
                        <div class="col-12 text-center">
                            ...
                            <a href="/consultar/documento" class="btn btn-dark my-3">
