                            ...
                            <table class="table table-bordered table-tramite tr11 mb-1" style="border:solid 2px #717171;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="format-numero">{{ $documento->full_documento }}</td>
                                    </tr>
                                    <tr>
                                ...
                                <table class="table table-bordered table-tramite tr11 mb-1" style="border:solid 2px #717171;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="format-numero">{{ $documento->docReferencia->full_nro_registro }}</td>
                                        </tr>
                                        <tr>
                                            <th  style="width:150px">Documento</th>
                            ...
                            @if ($documento->docAtendido)
                                <table class="table table-bordered table-tramite tr11 mb-1" style="border:solid 2px #717171;">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th  style="width:150px">Nro de Registro</th>
                                            <td class="format-numero">{{ $documento->docAtendido->full_nro_registro }}</td>
                                        </tr>
                                        <tr>
                                            <th  style="width:150px">Documento</th>
